...
const { p3_1, p3_2, p3_3, p3_4 } = require('../assets/Portfolio_v3');
const { p4_1, p4_2, p4_3, p4_4 } = require('../assets/Portfolio_v4');
...
export const projects = [
  {
    ...
    desktop: true,
    link: 'https://match00.github.io/Portfolio/v4/'
  },
  {
    title: 'Portfolio v3',
    subtitle: 'Strona portfolio typu Single Page Application',
    ...
    desktop: true,
    link: 'https://match00.github.io/Portfolio/v3/'
  },
  {
    title: 'Portfolio v2',
    subtitle: 'Strona portfolio typu Single Page Application',
